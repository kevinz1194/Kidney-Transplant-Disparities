...
<!-- All adult deceased recipients (Line 41) -->
<!-- KM curve among adult deceased recipients with EPTS < 20 by race/Figure 3 (Line 70) -->
<!-- KM curve among adult deceased recipients with EPTS < 20 by race, no 2015 (Line 105) -->
<!-- KM curve among adult deceased recipients with EPTS < 20 and top 20% KDPI by race (Line 136) -->
<!-- KM curve among adult deceased recipients with EPTS < 20 and top 20% KDPI by race, no 2015 (Line 171) -->
<!-- Cumulative incidence of death with function in top EPTS, graft failure competing risk (Line 201) -->
<!-- Cumulative incidence of death with function in top EPTS, graft failure competing risk, top KDPI adjust (Line 242) -->
...
### KM curve among adult deceased recipients with EPTS < 20 and top 20% KDPI by race
```{r, warning=F, echo=F, comment=NA, message=F, fig.align='center', fig.height=9, fig.width=9}
...
fit_top20_kpdi <- survival::survfit(Surv(time_tx_death_days / 365.25, death_functioning_graft) ~ race_tx, 
...
### KM curve among adult deceased recipients with EPTS < 20 and top 20% KDPI by race, no 2015
```{r, warning=F, echo=F, comment=NA, message=F, fig.align='center', fig.height=9, fig.width=9}
df_recipients_top20_kpdi_no2015 <- subset(df_recipients_top20_kpdi,
                                     year(as.Date(df_recipients_top20_kpdi$listing_date)) != 2015)


fit_top20_kdpi_no2015 <- survival::survfit(Surv(time_tx_death_days / 365.25, death_functioning_graft) ~ race_tx, 
