...
<!-- All adult recipients (Line 55) -->
<!-- KM curve for death with functioning graft with top EPTS < 20 by race/Figure 3 (Line 84) -->
<!-- KM curve for death with functioning graft with top EPTS < 20 by race, no 2015 (Line 119) -->
<!-- KM curve for death with functioning graft with EPTS < 20 and top 20% KDPI by race (Line 150) -->
<!-- KM curve for death with functioning graft with EPTS < 20 and top 20% KDPI by race, no 2015 (Line 185) -->
<!-- Cumulative incidence of death with function in top EPTS, graft failure competing risk (Line 216) -->
<!-- Cumulative incidence of death with function in top EPTS, graft failure competing risk, top KDPI adjust (Line 256) -->
...
fit_top20 <- survival::survfit(Surv(time_to_death_function / 365.25, death_with_function) ~ race_tx, 
...
df_recipients_top20_no2015 <- subset(df_recipients_top20,
                                     year(as.Date(df_recipients_top20$listing_date_tx)) != 2015)
...
df_recipients_top20_kpdi_no2015 <- subset(df_recipients_top20_kpdi,
                                     year(as.Date(df_recipients_top20_kpdi$listing_date_tx)) != 2015)
