...
<!-- Average EPTS by age group and race (Line 100) -->
<!-- Average EPTS by age group and race (Line 143)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 174)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 212) -->
<!-- -->
<!-- Average KDPI by age group and race (Line 249) -->
<!-- Average KDPI by age group and race (Line 292)  -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 321) -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 355) -->
<!-- -->
<!-- Logistic regression for EPTS (Line 389) -->
<!-- Logistic regression for KDPI (Line 402)  -->
<!-- -->
<!-- Survival plots for competing risks (Line 420) -->
<!-- Overall results for top 20% EPTS only (Line 486) -->
<!-- Adjusted results for age (Line 512) -->
