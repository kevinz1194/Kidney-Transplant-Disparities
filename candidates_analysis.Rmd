...
<!-- Average EPTS by age group and race (Line 102) -->
<!-- Average EPTS by age group and race (Line 146)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 176)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 227) -->
<!-- -->
...
<!-- -->
<!-- Logistic regression for EPTS (Line 414) -->
<!-- Logistic regression for KDPI (Line 427)  -->
<!-- -->
<!-- Survival plots for competing risks (Line 445) -->
<!-- Overall results for top 20% EPTS only (Line 510) -->
<!-- Adjusted results for age (Line 536) -->
...
df_cand_kipa_kdpi4 <- df_cand_kipa %>%
  ...
  summarise(result = round(100 * mean(top20_kdpi, na.rm=T), 2)) %>%
