...
<!-- Median dialysis time and preemptive listing in Top EPTS (Line 73) -->
<!-- Average EPTS by age group and race (Line 93) -->
<!-- Average EPTS by age group and race (Line 137)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 167)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 205) -->
<!-- -->
<!-- Average KDPI by age group and race (Line 242) -->
<!-- Average KDPI by age group and race (Line 285)  -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 314) -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 348) -->
<!-- -->
<!-- Logistic regression for EPTS (Line 382) -->
<!-- Logistic regression for KDPI (Line 395)  -->
<!-- -->
<!-- Survival plots for competing risks (Line 413) -->
<!-- Overall results for top 20% EPTS only (Line 479) -->
<!-- Adjusted results for age (Line 505) -->
...
df_cand_kipa_table1 <- df_cand_kipa %>%
  select(race, diabetes, age, sex, time, previous_TX, 
         preemptive_listing, dialysis_time_at_list, top_percentile_epts)


tbl_summary(df_cand_kipa_table1[ ,c(1:8)], by = race,
...
### Median dialysis time and preemptive listing in Top EPTS
```{r, warning=F, echo=F, comment=NA, message=F, fig.align='center', fig.width=9}
...
tbl_summary(df_cand_kipa_table1, by = race,
            label = list(preemptive_listing ~ 'Pre-Emptive Listing',                        
                        dialysis_time_at_list ~ 'Years on Dialysis Pre-Listing'),
