...
<!-- All adult donor candidates/Table 1 (Line 38) -->
<!-- Average EPTS by age group and race, all donors/Figure 1A (Line 64) -->
<!-- Average EPTS by age group and race, all donors, table (Line 107)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race, all donors/Figure 1B (Line 137)  -->
<!-- Logistic regression for EPTS, includes living donors (Line 188) -->
<!-- Survival plots for competing risks/Figure 2 (Line 211) -->
<!-- Overall results for top 20% EPTS only (Line 309) -->
<!-- Adjusted results for age (Line 337) -->
