...
<!-- Average EPTS by age group and race/Figure 1A (Line 65) -->
<!-- Average EPTS by age group and race (Line 109)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race/Figure 1B (Line 139)  -->
<!-- Logistic regression for EPTS (Line 191) -->
<!-- Logistic regression for KDPI (Line 205)  -->
<!-- Survival plots for competing risks/Figure 2 (Line 220) -->
<!-- Overall results for top 20% EPTS only (Line 310) -->
...
### Average EPTS by age group and race (Figure 1A)
...
### Average EPTS by age group and race
```{r, warning=F, echo=F, comment=NA, message=F, fig.align='center'}
...
### Proportion of candidates with EPTS < 20 by age group and race (Figure 1B)
```{r, warning=F, echo=F, comment=NA, message=F, fig.align='center'}
