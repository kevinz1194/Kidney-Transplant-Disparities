...
<!-- Average EPTS by age group and race, deceased donors, table (Line 110)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race, deceased donors/Figure 1B (Line 140)  -->
<!-- Logistic regression for EPTS, includes living donors (Line 192) -->
<!-- Logistic regression for KDPI, includes living donors (Line 206)  -->
<!-- Survival plots for competing risks/Figure 2 (Line 230) -->
<!-- Overall results for top 20% EPTS only (Line 328) -->
<!-- Adjusted results for age (Line 355) -->
