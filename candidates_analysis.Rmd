...
df_cand_kipa_cmp_facet <- df_cand_kipa_cmp %>%
  filter(age_group == '25-29' | age_group == '30-39' | age_group == '40-49')

top20_cuminc_age <- cuminc(Surv(time / 365.25, status_top20) ~ race + age_group, data = df_cand_kipa_cmp_facet) 
...
ggcuminc(top20_cuminc_age, 
  ...
  scale_color_manual(values = c(rep('#999999', 3),
                                rep('#E69F00', 3),
                                rep('#009E73', 3)),
                     labels = c('White or Caucasian (25-29)', 'Black or AA (25-29)', 'Hispanic/Latino (25-29)',
  ...
  scale_linetype_manual(values = rep(c('solid', 'dotted', 'dashed'), 3),
                        labels = c('White or Caucasian (25-29)', 'Black or AA (25-29)', 'Hispanic/Latino (25-29)',
                                   'White or Caucasian (30-39)', 'Black or AA (30-39)', 'Hispanic/Latino (30-39)',
                                   'White or Caucasian (40-49)', 'Black or AA (40-49)', 'Hispanic/Latino (40-49)')) +
  ggtitle('Cumulative Incidence of Top 20% KDPI with Death and Delisting as Competing Risks, by Selected Age and Race') +
  theme_bw() + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
