...
<!-- All adult deceased donor candidates (Line 48) -->
<!-- Median dialysis time and preemptive listing in Top EPTS (Line 73) -->
<!-- Average EPTS by age group and race (Line 103) -->
<!-- Average EPTS by age group and race (Line 146)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 177)  -->
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 228) -->
<!-- -->
<!-- Average KDPI by age group and race (Line 264) -->
<!-- Average KDPI by age group and race (Line 307)  -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 336) -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 370) -->
<!-- -->
<!-- Logistic regression for EPTS (Line 404) -->
<!-- Logistic regression for KDPI (Line 417)  -->
<!-- -->
<!-- Survival plots for competing risks (Line 436) -->
<!-- Overall results for top 20% EPTS only (Line 501) -->
<!-- Adjusted results for age (Line 527) -->
