...
library(pacman)
pacman::p_load(tidyverse, Hmisc, survival, survminer, ggplot2, gtsummary, knitr, kableExtra, cmprsk, ggsurvfit)
...
### Plot of Death 
death_cuminc <- cmprsk::cuminc(Surv(time / 365.25, status_death) ~ race, data = df_cand_kipa_cmp) 
...
top20_cuminc <- cmprsk::cuminc(Surv(time / 365.25, status_top20) ~ race, data = df_cand_kipa_cmp) 
