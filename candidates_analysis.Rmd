...
<!-- Proportion of candidates with EPTS < 20 by age group and race (Line 223) -->
<!-- -->
<!-- Average KDPI by age group and race (Line 260) -->
<!-- Average KDPI by age group and race (Line 303)  -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 332) -->
<!-- Proportion of candidates with KDPI < 20 by age group and race (Line 366) -->
<!-- -->
<!-- Logistic regression for EPTS (Line 400) -->
<!-- Logistic regression for KDPI (Line 413)  -->
<!-- -->
<!-- Survival plots for competing risks (Line 432) -->
<!-- Overall results for top 20% EPTS only (Line 497) -->
<!-- Adjusted results for age (Line 523) -->
